...
HD_PWD='C:/ECE532/test_gyro/test_gyro.runs/block1_axi_iic_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block1_axi_iic_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block1_axi_iic_0_1.tcl
