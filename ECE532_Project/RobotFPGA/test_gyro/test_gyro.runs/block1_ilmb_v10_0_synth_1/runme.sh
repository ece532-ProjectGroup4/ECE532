...
HD_PWD='C:/ECE532/test_gyro/test_gyro.runs/block1_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block1_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block1_ilmb_v10_0.tcl
