...
HD_PWD='C:/Users/Balaji/Desktop/ece532/newstream/tx/tx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tx_wrapper.tcl
