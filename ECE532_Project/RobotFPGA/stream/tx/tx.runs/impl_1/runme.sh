...
HD_PWD='C:/Users/Balaji/Desktop/ece532/newstream/tx/tx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tx_wrapper.tcl -notrace
