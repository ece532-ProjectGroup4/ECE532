...
#
# Generated by export_simulation on Tue Mar 19 21:30:55 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './tx.sh' script.
...
For more information on the script, please type './tx.sh -help'.
