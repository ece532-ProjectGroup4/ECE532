...
#
# Generated by Vivado on Thu Feb 22 22:56:10 -0500 2024
...
# Script info
echo -e "pll.sh - Script generated by export_simulation (Vivado v2018.3.1 (64-bit)-id)\n"
...
simulate()
{
  xsim pll -key {Behavioral:sim_1:Functional:pll} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/pll.protoinst" -log simulate.log
}
