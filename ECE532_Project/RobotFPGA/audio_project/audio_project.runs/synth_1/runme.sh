...
HD_PWD='C:/ECE532/audio_project/audio_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_axi_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_axi_v1_0.tcl
