...
HD_PWD='C:/Users/jpzjo/Downloads/newstream/newstream/rx/rx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rx_wrapper.tcl -notrace
