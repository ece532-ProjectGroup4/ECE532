...
module rx
   (ETH_REFCLK,
    ...
    vga_red_0,
    vga_vsync_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ETH_REFCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ETH_REFCLK, CLK_DOMAIN /clk_wiz_0_clk_out1, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.0" *) output ETH_REFCLK;
  ...
  assign ETH_REFCLK = clk_wiz_0_clk_100;
